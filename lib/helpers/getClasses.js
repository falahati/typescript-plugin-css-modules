...
var getClasses = function (_a) {
    ...
    try {
        ...
        if (options.customRenderer) {
            ...
            less_1.default.render(css, __assign(__assign({ syncImport: true, filename: fileName }, (rendererOptions.less || {})), { paths: __spreadArray([], (((_b = rendererOptions.less) === null || _b === void 0 ? void 0 : _b.paths) || [directory])) }), function (error, output) {
            ...
            var _c = rendererOptions.sass || {}, includePaths = _c.includePaths, sassOptions = __rest(_c, ["includePaths"]);
            var _d = compilerOptions.baseUrl, baseUrl = _d === void 0 ? directory : _d, paths = compilerOptions.paths;
